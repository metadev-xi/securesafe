<div align="center">
  <img src="./logo.png" width="128" height="128" alt="SecureSafe Logo" />
  <h1>SECURESAFE</h1>
  <p><strong>Hardware-grade security for mobile crypto storage</strong></p>
  ...
  [![Tech](https://img.shields.io/badge/stack-Swift%20%7C%20Kotlin%20%7C%20Secure%20Enclave-black.svg?style=for-the-badge)](https://0xtech.org)
</div>

---

<h2>Check Web3 Wallet</h2>
Live Demo: https://securesafe-demo.vercel.app/
<img src="./preview.png" alt="SecureSafe Preview" />

## 🌌 Overview

SecureSafe is a high-performance, web3 wallet platform engineered for professional traders and developers. By combining institutional-grade execution speed with a robust developer ecosystem, SecureSafe provides the foundational layer for hardware-grade security for mobile crypto storage.
...
SecureSafe provides a comprehensive API surface for both frontend interactions and external integrations.

- **`/api/core/*`**: Direct interaction with SecureSafe core features
...
<!-- Last Activity: 2026-02-04T00:13:06.534Z -->
